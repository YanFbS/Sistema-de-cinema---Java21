...
public class QuantidadeIngresso3D {
    ...
    public static final double VALOR_ENTRADA = 30.0;

    public static final double VALOR_CRIANCA = 15.0;

    public static final double VALOR_IDOSO = 21.0;

    public static final double VALOR_ESTUDANTE = 15.0;
    ...
    private static void exibirMenuIngressos(int restantes, int[] contagem) {
        ...
        System.out.println("1 - Entrada: 30R$");

        System.out.println("2 - Desconto especial: Menores de 12 anos: 15R$");

        System.out.println("3 - Desconto especial: Idosos com 60 anos (ou mais): 21R$");

        System.out.println("4 - Desconto especial: Alunos e Professores: 15R$");
